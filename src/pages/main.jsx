  ...
  return (
    ...
    <div className="flex lg:flex-row md:flex-row flex-col-reverse -mt-5 lg:px-20 ">
      <div className="lg:w-1/2 lg:p-8 lg:ml-12 ml-8 mr-8 text-center lg:text-left">
        <h2 className="lg:text-6xl text-4xl lg:mt-16  bg-gradient-to-r from-blue-900  via-blue-800 to-blue-800 inline-block text-transparent bg-clip-text font-bold mb-4">Make your next <br />hire with <br /><span className=''> Career Hub</span></h2>
